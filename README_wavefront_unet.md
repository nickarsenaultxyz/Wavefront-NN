...
```
Wavefront Set Neural Network - U-Net Implementation
...
- Multi-label classification approach for handling geometric singularities
- Training performed on Google Colab with Tesla T4 GPU
